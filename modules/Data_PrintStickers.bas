Attribute VB_Name = "Data_PrintStickers"
' This script will take a production order number and
' print the stickers from SAP using the zint page

Sub Data_GetPrintStickers()

On Error GoTo Catch

If Sheets("Data").OLEObjects("StickersReprint").Object.Value = True Then
    Call Data_PrintStickers_Forced.Data_GetPrintStickers_Forced
Else
    ...
    Else
        ...
        Next repeat
            ...
            Do While counter < totalOrders
                ...
                session.findById("wnd[0]/usr/txtV_BOX_QTY").Text = "1"  '"Boxes per unit" value
                session.findById("wnd[0]/usr/txtV_BOX_QTY").caretPosition = 1

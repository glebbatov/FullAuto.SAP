Attribute VB_Name = "Data_PrintLabNotes"
' This script will take a production order number and
' print the lab notes from SAP using the co02 page

Sub Data_GetPrintLabNotes()

On Error GoTo Catch

If Sheets("Data").OLEObjects("LabnotesReprint").Object.Value = True Then
    Call Data_PrintLabNotes_Forced.Data_GetPrintLabNotes_Forced
Else
